...
![year and exit_year](~/Dropbox/fas_1001_Zhuk/_travail_session/limits/year and year_exit .png)

![year and exit_year_2](~/Dropbox/fas_1001_Zhuk/_travail_session/limits/year and exit_year_2.png)
...
provinces_clean_unique <- provinces_clean_unique |> filter(year >= 1961)
...
graph_1 <- ggplot(data = provinces_clean_unique, aes(x = year_of_birth)) +
  ...
  scale_x_continuous(limits = c(1920, 2000), 
...
legislative_age <- provinces_clean_unique |> 
